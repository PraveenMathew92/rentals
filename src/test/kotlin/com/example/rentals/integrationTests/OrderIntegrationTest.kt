...
class OrderIntegrationTest {
    ...
    @Test
    fun `basic CRUD`() {
        val customer = Customer("test-email@test.com", "Test", 1234567890)

        val asset = Asset(UUID.fromString("39cf3c7c-f449-4cd4-85e1-bc61dd2db64e"),
                "Swift Dzire",
        ...
        client.get()
                .uri("/order/customer/test-email@test.com/asset/39cf3c7c-f449-4cd4-85e1-bc61dd2db64e")
                .exchange()
                .expectStatus().isOk
